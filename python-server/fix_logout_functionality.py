...
def print_instructions():
    ...
    print("   add this function right before the performLogout function (around line 700):")
    print("   ```javascript")
    print("   /**")
    ...
    print("   to check for the presence of self.tokenCheckIntervalId without calling stopTokenChecking:")
    print("   ```javascript")
    print("   // Inside the performLogout function, replace the line that calls stopTokenChecking()")
    print("   // with:")
    print("   if (self.tokenCheckIntervalId) {")
    print("       clearInterval(self.tokenCheckIntervalId);")
    print("       self.tokenCheckIntervalId = null;")
    ...
    print("   If you can't modify the server, you can update the client to use GET instead of POST")
    print("   In background.js, find the fetch call in the performLogout function (around line 710)")
    print("   Change:")
    print("   ```javascript")
    print("   await fetch(`${API_BASE_URL}/auth/oauth/v2/logout?user_id=${encodeURIComponent(tokenState.userId)}`, {")
