...
def find_place_manually():
    ...
    print(f"2. Go to line {function_end_line+1} (the closing brace of the GET logout function)")
...
""")
    ...
    print("3. After the closing brace of that function, paste the contents of post_endpoint.py")
...
def print_instructions():
    ...
    print("   - OR modify the performLogout function to use method: 'GET' instead of 'POST'")
